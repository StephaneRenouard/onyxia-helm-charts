...
grep -n -- "--bind-tcp=0.0.0.0:8080,auth=none" "${CHART_DIR}/image/onyxia-init.sh"
...
grep -n -- "--bind-tcp=0.0.0.0:8080,auth=none" "${TMP_DIR}/premyom-slicer/image/onyxia-init.sh"
