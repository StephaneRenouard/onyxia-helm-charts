...
grep -n "premyom_slicer.html?scale=%s" "${CHART_DIR}/templates/deployment.yaml"
...
grep -n "premyom_slicer.html?scale=%s" "${TMP_DIR}/premyom-slicer/templates/deployment.yaml"
...
grep -n "premyom-slicer-kasm-ui" "${CHART_DIR}/image/onyxia-init.sh"
grep -n "premyom-slicer-fit-window" "${CHART_DIR}/image/onyxia-init.sh"
...
grep -n "premyom-slicer-kasm-ui" "${TMP_DIR}/premyom-slicer/image/onyxia-init.sh"
grep -n "premyom-slicer-fit-window" "${TMP_DIR}/premyom-slicer/image/onyxia-init.sh"
